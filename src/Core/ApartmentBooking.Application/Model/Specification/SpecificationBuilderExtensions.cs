    ...
    public static class SpecificationBuilderExtensions
    {
            ...
            Type propertyType)
        {
            ...
            if (propertyType.IsEnum)
            {
                ...
                if (!Enum.TryParse(propertyType, stringEnum, true, out var valueparsed)) throw new Exception(string.Format("Value {0} is not valid for {1}", value, field));
            ...
            if (propertyType == typeof(Guid))
            {
                ...
                if (!Guid.TryParse(stringGuid, out var valueparsed)) throw new Exception(string.Format("Value {0} is not valid for {1}", value, field));
